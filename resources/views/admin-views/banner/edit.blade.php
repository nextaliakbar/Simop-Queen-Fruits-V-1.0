                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{$banner['title']}}" class="form-control"
                                            placeholder="Banner Baru" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label">Jenis Banner<span class="text-danger ml-1">*</span></label>
                                        <select name="item_type" class="custom-select">
                                            <option value="product" {{$banner['product_id']==null?'':'selected'}}>Produk</option>
                                            <option value="category" {{$banner['category_id']==null?'':'selected'}}>Kategori</option>
                                        </select>
                                    </div>
