                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label">Judul<span class="text-danger ml-1">*</span></label>
                                        <input type="text" name="title" class="form-control" placeholder="Banner Baru" required>
                                    </div>

                                    <div class="form-group">
                                        <label class="input-label">Jenis Banner<span class="text-danger ml-1">*</span></label>
                                    ...
                                    <div class="form-group" id="type-product">
                                        <label class="input-label">Produk <span class="text-danger ml-1">*</span></label>
                                    ...
                                    <div class="form-group type-category" id="type-category">
                                        <label class="input-label">Kategori <span class="text-danger ml-1">*</span></label>
                            ...
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group">
                                        <input id="datatableSearch_" type="search" name="search" value="{{ $search }}" class="form-control" placeholder="Cari berdasarkan judul" aria-label="Search" required="" autocomplete="off">
                            ...
                            <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                                ...
                                @foreach($banners as $key=>$banner)
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img-vertical-150" src="{{$banner->imageFullPath}}" alt="banner image">
                                        </td>
                                        <td>
                                        ...
                                        @if(isset($banner->category_id))
                                            <td>Kategori: {{substr(\App\Models\Category::find($banner->category_id)?->name, 0, 15)}}</td>
                                        @elseif(isset($banner->product_id))
                                            <td>Produk: {{ substr(\App\Models\Product::find($banner->product_id)?->name,0, 15) }}...</td>
                                        @else
                                            <td></td>
                                        @endif
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <button type="button" class="btn btn-outline-danger btn-sm delete square-btn form-alert" data-id="banner-{{$banner['id']}}" data-message="Ingin menghapus banner ini?"
