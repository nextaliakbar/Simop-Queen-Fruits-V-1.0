                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="input-label" for="exampleFormControlInput1">Nama<span class="text-danger ml-1">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="input-label">Password <span class="text-danger ml-1">(*Masukkan password baru jika ingin mengatur ulang)</span></label>
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="150" src="{{$branch->imageFullPath}}" alt="branch image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="150" src="{{$branch->coverImageFullPath}}" alt="branch cover image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="number" name="coverage" min="1" max="1000" class="form-control" placeholder="Contoh : 10" value="{{ $branch['coverage'] }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" id="location_map_div">
                                        <input id="pac-input" class="controls rounded" data-toggle="tooltip"
                                               ...
                                               data-original-title="Cari lokasi mu disini"
