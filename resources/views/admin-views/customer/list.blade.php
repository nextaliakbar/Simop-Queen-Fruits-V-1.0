                        ...
                        <form action="{{url()->current()}}" method="GET">
                            <div class="input-group">
                                <input id="datatableSearch_" type="search" name="search"
                                    class="form-control"
                                    placeholder="Cari berdasarkan nama, no.hp, atau email" aria-label="Search"
                            ...
                            <tr class="">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button class="btn btn-outline-danger btn-sm square-btn form-alert"  data-id="customer-{{$customer['id']}}" data-message="Ingin menghapus pelanggan ini?" >
        ...
        function add_point(form_id, route, customer_id) {
            ...
            $.post({
                ...
                success: function (data) {
                    $('.show-point-' + customer_id).text('Poin Tersedia ' + data.updated_point + ' )');
