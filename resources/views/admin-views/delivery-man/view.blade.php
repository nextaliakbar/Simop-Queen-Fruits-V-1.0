                    ...
                    <div class="col-md-5 d-flex justify-content-center">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xxl mr-4">
                                <img class="img-fit" src="{{$deliveryman->imageFullPath}}" alt="deliveryman">
                            </div>
                            <div class="d-block">
                                ...
                                <p> {{$deliveryman->reviews->count()}} Review
                    ...
                    <div class="col-md-7">
                        ...
                        @php($total=$deliveryman->reviews->count())
                            <li class="d-flex align-items-center font-size-sm">
                                ...
                                <span class="progress-name">Bagus Sekali</span>
                                    ...
                                    <a class="d-flex align-items-center"
                                       href="{{route('admin.customer.view',[$review['user_id']])}}">
                                        ...
                                        <span class="d-block h5 text-hover-primary mb-0">{{$review->customer['f_name']." ".$review->customer['l_name']}} <i
                                                ...
                                                title="Pelanggan Terverifikasi"></i></span>
