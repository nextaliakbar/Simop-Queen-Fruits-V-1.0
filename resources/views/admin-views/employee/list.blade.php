                        ...
                        <div class="d-flex flex-wrap justify-content-md-end gap-3 ">
                            <form action="{{url()->current()}}" method="GET">
                                <div class="input-group">
                                    <input id="datatableSearch_" type="search" name="search" class="form-control" placeholder="Cari berdasarkan nama, email, atau no. hp" aria-label="Search" value="" required="" autocomplete="off">
                                ...
                                <tr>
                                    ...
                                    <td class="text-capitalize">
                                        <div class="media align-items-center gap-3">
                                            <div class="avatar">
                                                <img class="img-fit rounded-circle" src="{{$employee->imageFullPath}}" alt="employee">
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a data-id="employee-{{$employee->id}}" data-message="Ingin menghapus karyawan ini?"
