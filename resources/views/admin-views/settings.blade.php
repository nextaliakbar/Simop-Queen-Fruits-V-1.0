                ...
                @csrf
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="phoneLabel" class="col-sm-3 col-form-label input-label">No. Handphone <span
                                        class="input-label-secondary">Opsional</span></label>

                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           placeholder="+628123456789" aria-label="+628123456789"
                                           value="{{auth('admin')->user()->phone}}"
                                           data-hs-mask-options='{
                                           "template": "+629123456789"
                                         }'>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           ...
                                           placeholder="Masukkan email baru" aria-label="Enter new email address">
                                </div>
                            </div>
