    ...
    <div class="content container-fluid">
        <div>
            ...
            <ul class="nav nav-tabs border-0 my-2">
                <li class="nav-item">
                    <a class="nav-link {{Request::is('branch/verify-offline-payment/pending')?'active':''}}"  href="{{route('branch.verify-offline-payment', ['pending'])}}">Pesanan Tertunda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{Request::is('branch/verify-offline-payment/denied')?'active':''}}"  href="{{route('branch.verify-offline-payment', ['denied'])}}">Pesanan Tertolak</a>
                </li>
            </ul>
        </div>
