                ...
                <div class="modal-body pb-5 pt-0">
                    <div class="max-349 mx-auto mb-20">
                        ...
                        <div class="btn--container justify-content-center">
                            <button type="button" id="toggle-status-ok-button" class="btn btn-primary min-w-120" data-dismiss="modal" onclick="confirmStatusToggle()">Ok</button>
...
<script>
    ...
    window.addEventListener('online', function() {
        toastr.success('Sedang online');
    });
    window.addEventListener('offline', function() {
        toastr.error('Sedang offline');
    });

    //Internet Status Check (after any event)
    document.body.addEventListener("click", function(event) {
        if(window.navigator.onLine === false) {
            toastr.error('Kamu sedang offline');
